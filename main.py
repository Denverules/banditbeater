...
def fight():
    global maxhealth,yourelem,swordskill,defense,coins,robbed,banditdefeated,boss
...
def play():
    global difficulty,robbed,boss
    quitting = False

    while not quitting and not boss:
        ...
        if action == 'quit':
            ...
            print('your current stats are', maxhealth, 'max health,', speed, 'speed,', defense, 'defense,', swordskill,
                  'sword skill,', elskill, 'elemental skill', intel, 'intelligence')
        elif action == 'shop':
            shop(coins)
